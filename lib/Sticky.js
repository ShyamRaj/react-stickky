  ...
  (0, _react.useEffect)(function () {
    var calculateWidth = function calculateWidth() {
      ...
      if (elementWidth !== width) {
        (0, _debounce["default"])(setWidth(elementWidth ? elementWidth : '100%'), 10);
      }
    };
    ...
    var handleScroll = function handleScroll() {
      ...
      if (window.pageYOffset + scrollBuffer > sIndex) {
        (0, _debounce["default"])(setScrollLock(true), 10);
      } else if (window.pageYOffset - scrollBuffer < sIndex) {
        (0, _debounce["default"])(setScrollLock(false), 10);
      }
    };
    ...
    window.addEventListener('resize', calculateWidth); // this will clean up the event every time the component is re-rendered
